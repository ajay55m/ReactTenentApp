// NoInternetConnectionWrapper.jsx
...
const NoInternetConnectionWrapper = ({
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Wrapper Header - only render when not suppressed/detected */}
      {renderWrapperHeaderFooter && (
        <View
      ...
      <View
        style={[
          styles.contentArea,
          renderWrapperHeaderFooter ? { marginTop: HEADER_HEIGHT, marginBottom: FOOTER_HEIGHT } : { marginTop: 0, marginBottom: 0 },
        ]}
      >
        {/* ALWAYS show children so page content remains visible and usable */}
        <View style={styles.childrenContainer}>{children}</View>
      </View>

      {/* Wrapper Footer - only render when not suppressed/detected */}
      {renderWrapperHeaderFooter && (
